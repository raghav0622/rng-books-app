...
const EditBookMetaForm: React.FC<{
  book: Book;
}> = ({ book }) => {
    ...
    <RNGForm
      ...
      uiSchema={[
        ...
        },
        {
          ...
          valueOnNoRender: (d) => (d.bankDetail ? book.bankName : undefined),
        },
        {
          name: 'ifscCode',
          ...
          renderLogic: (d) => !!d.bankDetail,
          valueOnNoRender: (d) => (d.bankDetail ? book.ifscCode : undefined),
        },
        {
          name: 'accountNumber',
...
export default EditBookMetaForm;
